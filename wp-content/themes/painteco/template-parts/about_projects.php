<div class="container projects" id="projects">
    <div class="row">
        <?php $post = get_post(icl_object_id(254, 'page')); ?>
        ...
        <div class="col-sm-6 text">
            ...
            <a href="<?php echo get_permalink($post); ?>" class="read-more dark"><?php echo esc_html__( 'Lasīt vairāk', 'painteco' ); ?> <span class="glyphicon glyphicon-play" aria-hidden="true"></span></a>
        </div>
