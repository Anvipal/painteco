<div class="row">
    ...
    <div class="col-sm-6">
        ...
        <ul class="product-components-list list-unstyled">
            ...
            foreach (get_field('product_components') as $code) :
                ?>
                <li><a href="#" title="<?php echo $components[$code]['title']; ?>" style="background: url(<?php echo get_stylesheet_directory_uri();?>/images/<?php echo $components[$code]['icon']; ?>) no-repeat;">
