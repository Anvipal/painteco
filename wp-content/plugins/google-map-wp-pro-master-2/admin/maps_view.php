    ...
    <div class="maps_list_container">
        ...
        <table class="maps_table">
            ...
            <tr>
                ...
                <th scope="col" id="name" style="width:85px"><span>Action</span><span class="sorting-indicator"></span>
                </th>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="slider-container" style="float:left; width:55%; height:25px; ">
                                        ...
                                        <span style="position:absolute; top: 4px;left: 160px;"><?php echo $thisMap->width; ?>
                                            %</span>
                                    </div>
                                </li>
                                <li class="has_background">
                ...
                <li class="markers_editor editing_section">
                    ...
                    <div class="edit_content hide" id="g_map_marker_options">
                            ...
                            <div class="hidden_edit_content hide">
                                ...
                                <ul>
                                    <li class="has_background">
                                        ...
                                        <input type="text" id="marker_location" autocomplete="off" name="marker_location"/>
                                    </li>
                                    <li>
                                    ...
                                    <li class="city_container">
                                        <label for="marker_city">City</label>
                                        <input class="city" id="marker_city" name="marker_city" type="text" autocomplete="off"/>
                                    </li>
                                        ...
                                        <ul>
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/default-icon.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/marker48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                                       class="marker_image_change_marker marker_image_choose_button"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/azuremarker48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/redmarker48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/bluemarker48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/greenmarker48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/starmarker48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/blackmarker48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/pinleft48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/pinpink48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/pinright48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/toyflag48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/greenflag48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/flagleft48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/pinkflag48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/blueflag48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/flagright48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/paperflag48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/pointleft48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/redflag48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/baseflag48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/pointright48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/pinkleft48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/pinkgreen48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/pinkright48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/pointcenter48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/star48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/pointer48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                                            ...
                                            <li>
                                                <div class="imag_block">
                                                    <img src="<?php echo plugins_url( "../images/icons/shopmarker48.png",
														__FILE__ ); ?>" alt=""/>
                                                </div>
                                                <input type="radio"
                        ...
                        <div id="markers_edit_exist_section">
							...
							$id            = $_GET['id'];
							$i             = 1;
							$sql           = $wpdb->prepare( "SELECT * FROM " . $wpdb->prefix . "g_markers WHERE map=%s",
								$id );
                            ...
                            <div class="update_list_item hide">
                                ...
                                <ul>
                                    <li class="has_background">
                                        ...
                                        <input autocomplete="off" type="text" id="marker_edit_location" name="marker_edit_location"/>
                                    </li>
                                    <li>
...
<!--                                    </li>-->
                                    <li class="city_container">
                                        <label for="marker_edit_city">City</label>
                                        <input class="city" id="marker_edit_city" name="marker_edit_city" type="text" autocomplete="off"/>
                                    </li>
                                    <li class="phone_container">
                                        <label for="marker_edit_phone">Phone</label>
                                        <input class="phone" autocomplete="off" id="marker_edit_phone" name="marker_edit_phone" type="tel"/>
                                    </li>
                                    <li class="marker_image_choose">
                    ...
                    <div class="edit_content hide">
                        <div id="g_map_polygone_options">
                            ...
                            <div id="polygone_edit_exist_section">
								...
								$id              = $_GET['id'];
								$i               = 1;
								$sql             = $wpdb->prepare( "SELECT * FROM " . $wpdb->prefix . "g_polygones WHERE map=%s",
									$id );
                    ...
                    <div class="edit_content hide">
                        <div id="g_map_polyline_options">
                            ...
                            <div id="polyline_edit_exist_section">
								...
								$id              = $_GET['id'];
								$i               = 1;
								$sql             = $wpdb->prepare( "SELECT * FROM " . $wpdb->prefix . "g_polylines WHERE map=%s",
									$id );
                    ...
                    <div class="edit_content hide">
                        <div id="g_map_circle_options">
                                ...
                                <div class="hidden_edit_content hide">
                                    ...
                                    <ul>
                                        ...
                                        <li class="has_background">
                                            ...
                                            <input type="radio" class="radio circle_marker_show" id="circle_marker_show"
                                                   name="circle_marker_show" value="1"/>
                                            <label class="radio_label" for="circle_marker_show">NO</label>
                                            <input type="radio" class="radio circle_marker_show" id="circle_marker_show"
                                                   name="circle_marker_show" value="0" checked/>
                                        </li>
                                        <li>
                            ...
                            <div id="circle_edit_exist_section">
								...
								$id            = $_GET['id'];
								$i             = 1;
								$sql           = $wpdb->prepare( "SELECT * FROM " . $wpdb->prefix . "g_circles WHERE map=%s",
									$id );
                                ...
                                <div class="update_list_item hide">
                                    ...
                                    <ul>
                                        ...
                                        <li class="has_background">
                                            ...
                                            <input type="radio" class="radio circle_edit_marker_show"
                                                   name="circle_edit_marker_show" id="circle_edit_marker_show_true"
                                                   value="1">
                                            <label class="radio_label" for="circle_edit_marker_show">NO</label>
                                            <input type="radio" class="radio circle_edit_marker_show"
                                                   name="circle_edit_marker_show" id="circle_edit_marker_show_false"
                                                   value="0">
                                        </li>
                                        <li>
                                            <label for="circle_radius">Radius(meter)</label>
